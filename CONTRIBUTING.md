...
3. **Commit your changes**: Make small, logical commits with clear messages.
...
2. **Créez une branche** : Créez une nouvelle branche pour votre fonctionnalité ou correction de bug (`git checkout -b feature/ma-nouvelle-feature`).
3. **Commitez vos changements** : Faites de petits commits logiques avec des messages clairs.
4. **Poussez sur votre fork** : Poussez vos changements sur votre fork GitHub.
